...
export default function Surebets() {
  ...
  useEffect(() => {
    // Leer surebets desde la API (no Supabase directo)
      ...
      {cargando ? (
        ...
        <div style={{
          ...
          <p style={{ color: "#64748b", fontSize: "12px" }}>
            Se buscan automáticamente a las 11:00h y 17:00h.
          </p>
        </div>
      ) : (
        surebets.map((s, i) => (
          <div key={i} style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px", marginBottom: "10px" }}>
              {[
                ...
                <div key={label} style={{ background: "#0f172a", borderRadius: "8px", padding: "10px" }}>
            ...
            <p style={{ fontSize: "10px", color: "#64748b", margin: "8px 0 0 0" }}>
              ⚠️ Verifica las cuotas antes de apostar.
            </p>
          </div>
        ))
      )}
